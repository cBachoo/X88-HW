...
You are free to produce, modify, manufacture, and distribute this design, including for commercial purposes, provided you give appropriate credit and license any derivative works under the same terms.

Questions? Contact Bachoo (`bachoobusiness[at]gmail.com`).
...
The 3D model for the PCB can be seen in the main folder under `X88J-3D-model.step`.
